const countries = [
	{
			...
			"population": 40218234,
			"flag": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Flag_of_Afghanistan_%282013%E2%80%932021%29.svg/510px-Flag_of_Afghanistan_%282013%E2%80%932021%29.svg.png",
			"region": "Asia",
			"area": 652230
	},
	{
	...
	{
			"name": "United States of Americas Team B",
			"capital": "Washington, D.B",
			"languages": [
					"English"
			],
			"population": 300,
...
function renderResult(data){
	...
	for(let i=0; i<data.length; i++){
		...
		countryFlagContainer = document.createElement('div');
		countryFlagContainer.className = 'country-flag-container';
		...
		languages.textContent = data[i].languages.join(', ');

		population = document.createElement('p');
		population.textContent = commafy(data[i].population);
