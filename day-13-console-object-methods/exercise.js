...
console.log(`10 > 2 * 10 use console.assert()`);
console.assert(10 > 2*10, '10 is not greater than 2 * 10', `\n`);

// 2. Write a warning message using console.warn()
    console.log(`Write a warning message using console.warn()`);
    console.warn('this is a warning, not an error', `\n`);

// 3. Write an error message using console.error()
    console.log(`Write an error message using console.error()`);
    console.error('this is an error, but not a big problem if you get an error in your code', `\n`);
...
// 1. Check the speed difference among the following loops: while, for, for of, forEach
    ...
    console.time('while loop times count');
    while(number < number.length){
        number++;
    }
    console.timeEnd('while loop times count');
    console.log(`\n`);
    
    console.time('for loop times count');
    for(let i=0; i<number.length; i++){
        number[i]++;
    }
    console.timeEnd('for loop times count');
    console.log(`\n`);

    console.time('for of loop times count');
    for(const num of number){
        num;
    }
    console.timeEnd('for of loop times count');
    console.log(`\n`);

    console.time('for each loop times count');
    number.forEach(num => num);
    console.timeEnd('for each loop times count');
