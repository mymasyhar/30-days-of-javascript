...
// 1. How many languages are there in the countries object file.
    ...
    const countryLanguages = countries.map(country => Object.values(country.languages));
    const result = countryLanguages.reduce((prev, curr) => prev.concat(curr), []);
    const languagesResult = new Set(result);
    console.log(languagesResult.size, `\n`);

// 2. *** Use the countries data to find the 10 most spoken languages:
    console.log(`*** Use the countries data to find the 10 most spoken languages:`);
    function mostSpokenLanguage(countries, numOf){
        const languagesGroup = {};
        for(let lang of result){
            if(!languagesGroup[lang]){
                languagesGroup[lang] = 1;
            }else{
                languagesGroup[lang]++;
            }
        }
        const sortedLanguage = Object.entries(languagesGroup).sort((a,b) => b[1] - a[1]);
        return sortedLanguage.splice(0, numOf);
    }
